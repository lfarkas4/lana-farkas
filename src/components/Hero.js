...
<span className="tagline-gtxs">
  ...
  <br />
  and playful <span className="font-cooper-italic-tag">front-end</span> thinking.
</span>
          ...
          <span className="tagline-xs">
            ...
            <span className="line"><span className="font-cooper-italic-tag">front-end</span> thinking.</span>
          </span>
          {/* <span className="tagline-xs">
            <span className="line">… a product designer driven by</span>
