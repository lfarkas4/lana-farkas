...
export default function UnderConstructionPage({ projectName = "This project" }) {
  ...
  return (
    <div className="uc-page">
      {/* Only mount cosmic bg for this page, and respect reduced motion */}
      {!reduceMotion && <CosmicBackground showFluidCursor={true} />}
        ...
        <div className="uc-game">
            ...
            {gameState === "idle" ? (
              ...
              <div className="uc-orbs">
                {[0, 1, 2].map((orbIndex) => (
                  ...
                  >
                    <span
                      className={`uc-orb__star ${
                        showStar(orbIndex) ? "uc-orb__star--visible" : ""
                      }`}
                    >
                      ✦
                    </span>
          ...
          {gameState !== "idle" && (
            <div className="uc-game__status">
              ...
              {gameState === "reveal" && (
                <span
                  className={`uc-game__result ${
                    lastResult === "correct"
                      ? "uc-game__result--correct"
                      : "uc-game__result--wrong"
                  }`}
                >
